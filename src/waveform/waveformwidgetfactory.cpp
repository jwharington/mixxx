...
void WaveformWidgetFactory::slotSkinLoaded() {
    qInfo() << "[startup-trace] WaveformWidgetFactory::slotSkinLoaded begin";
    setWidgetTypeFromConfig();
    qInfo() << "[startup-trace] WaveformWidgetFactory::slotSkinLoaded first pass done";
    ...
    qInfo() << "[startup-trace] WaveformWidgetFactory::slotSkinLoaded second pass begin";
    setWidgetTypeFromConfig();
    qInfo() << "[startup-trace] WaveformWidgetFactory::slotSkinLoaded second pass done";
#endif
    qInfo() << "[startup-trace] WaveformWidgetFactory::slotSkinLoaded end";
}
